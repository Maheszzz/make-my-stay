...
export function Footer() {
    return (
        <footer className="bg-brand-dark border-t border-white/10 pt-16 pb-8 text-slate-400">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center space-x-2 mb-6">
                            <div className="p-1.5 bg-gradient-to-br from-brand-500 to-teal-600 rounded-lg">
                                <Building2 className="w-5 h-5 text-white" />
                            </div>
                            <span className="text-xl font-bold text-white tracking-tight">
                                MakeMyStay<span className="text-brand-500">.ai</span>
                            </span>
                        </div>
                        ...
                        <div className="flex space-x-4">
                            <div className="w-8 h-8 rounded-full bg-white/5 hover:bg-brand-500/20 hover:text-brand-500 flex items-center justify-center transition-colors cursor-pointer"><Mail size={16} /></div>
                            <div className="w-8 h-8 rounded-full bg-white/5 hover:bg-brand-500/20 hover:text-brand-500 flex items-center justify-center transition-colors cursor-pointer"><Phone size={16} /></div>
                        </div>
                    </div>

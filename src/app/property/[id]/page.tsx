...
import { MapPin, Bed, Bath, Hash, Check, Star, Share2, Heart, Calendar } from 'lucide-react';
import Link from 'next/link';

export default function PropertyPage({ params }: { params: { id: string } }) {
    // Mock Data based on params (In real app, fetch from DB)
    const property = {
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="relative">
                        <div className="sticky top-24 space-y-6">
                            ...
                            <Link href="/contact-us" className="bg-slate-900 rounded-3xl p-6 text-white flex items-center justify-between shadow-xl hover:bg-slate-800 transition-colors group">
                                <div>
